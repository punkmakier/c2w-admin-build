...
const storeData = { username: store[0].username, token: store[0].token, gameType: '2D' };
const summary = ref([
...
const declare = () => {
    if (declareNum.firstNum == null || declareNum.secondNum == null) {
...
<template>
    <div style="width: 70%; margin: 0 auto">
        ...
        <div class="countdown">
            <h3 style="position: absolute; left: 3%; top: 10%; color: #fff">EZ - 2</h3>
            <span>Countdown</span>
            ...
            <div class="col-12 lg:col-6 xl:col-6">
                <div class="card">
                    ...
                    <div class="mt-3">
                        ...
                        <Button severity="primary" label="Save" class="w-full mt-3" />
                    </div>
                </div>
            </div>
